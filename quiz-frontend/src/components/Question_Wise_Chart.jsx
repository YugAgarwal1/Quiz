...
export default function QuestionWiseChart({title, labels, data}) {
            ...
            <div className="flex items-center justify-between gap-8">
                ...
                <div className="flex-1 space-y-4">
                    ...
                    <div className="flex items-center justify-between">
                        ...
                        <span className="text-sm font-bold text-gray-800">{data[0]}</span>
                    </div>
                    ...
                    <div className="flex items-center justify-between">
                        ...
                        <span className="text-sm font-bold text-gray-800">{data[1]}</span>
                    </div>
                    ...
                    <div className="flex items-center justify-between">
                        ...
                        <span className="text-sm font-bold text-gray-800">{data[2]}</span>
                    </div>
                </div>
            </div>
        </div>
